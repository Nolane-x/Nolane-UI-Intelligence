...
`v0.10.0` · `374 个 canonical skills` · `9 个 Agent projection` · `MCP + CLI` · `证据门控` · `MIT`
...
Agent 不应该一次性加载 374 个 skill。Router 会根据当前任务选择**最小但足够的 owner graph**。

---

## 374 个 canonical design faculties

NUI 当前保持 **374 个 canonical skills**。这个数字只是当前系统规模，不是制造重复 expert 的 KPI。长期 UI-industry roadmap 会继续朝约 1,000 个 canonical faculties 扩展，但每个新增 skill 仍必须拥有独立的 decision ownership，并保持最小充分路由。
