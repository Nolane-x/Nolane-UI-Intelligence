...
description: Own concurrency semantics for shared graph editing, including conflicting structural edits, attribution, intent visibility, soft locks, and convergence after simultaneous node or edge changes.
---
