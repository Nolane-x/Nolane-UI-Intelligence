...
description: Own precision snapping in three dimensions across grid, vertex, edge, face, midpoint, center, tangent, axis, plane, and custom references with visible target and coordinate context.
---
