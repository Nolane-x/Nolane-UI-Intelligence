...
description: Use when this specialist's decision ownership is materially in scope. Own finding, revealing, jumping to, and returning from graph entities or paths without losing structural context, especially across collapsed or virtualized regions.
---
