...
description: Own temporary deployment locks on targets or release paths, including owner, reason, scope, expiry, override authority, visibility, and stale-lock recovery.
---
