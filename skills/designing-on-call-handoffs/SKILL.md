...
description: Own continuity across responder shift changes, including active incidents, pending alerts, role transfer, unresolved hypotheses, mitigation state, and acknowledgement by the incoming responder.
---
