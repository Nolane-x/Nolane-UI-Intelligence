...
description: Own detailed audio parameter automation envelopes across volume, pan, sends, effects, modes, breakpoints, interpolation, thinning, write passes, and safe editing against the mixer.
---
