...
description: Own financial budget authoring across versions, periods, accounts/dimensions, assumptions, top-down and bottom-up inputs, allocations, scenarios, approvals, locks, and actual-versus-budget lineage.
---
