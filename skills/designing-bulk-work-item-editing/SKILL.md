...
description: Own safe multi-item project edits with heterogeneous current values, eligibility checks, partial failure reporting, preview, and recoverability.
---
