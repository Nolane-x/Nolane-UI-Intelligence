...
description: Own component-level mesh selection across object, vertex, edge, face, element, loop, ring, connected, and occlusion-aware modes with stable feedback and mode transitions.
---
