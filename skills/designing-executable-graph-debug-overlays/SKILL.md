...
description: Use when this specialist's decision ownership is materially in scope. Own debug-state overlays for runnable graphs, exposing execution position, queued/running/failed states, data or token movement, breakpoints, stepping, and replay without corrupting authoring context.
---
