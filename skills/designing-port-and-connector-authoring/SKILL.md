...
description: Use when this specialist's decision ownership is materially in scope. Own discoverability, compatibility, direction, creation, reconnection, and cancellation of semantic graph connections through ports or connection targets.
---
