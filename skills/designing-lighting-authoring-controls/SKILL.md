...
description: Use when this specialist's decision ownership is materially in scope. Own 3D lighting setup across light types, position/orientation, intensity/units, color/temperature, environment light, shadows, grouping, preview quality, and render-context visibility.
---
