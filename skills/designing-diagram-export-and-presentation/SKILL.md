...
description: Own diagram-specific static and presentation outputs, including bounds, pagination, vector fidelity, themes, labels, hidden state, and narrative focus.
---
